  ...
  describe '#sign md5' do
    specify 'test sign md5 success' do
      expect(LlPay::Sign::MD5.sign(LlPay.md5_key, 'oid_partner=201103171000000000&dt_order=20130515094013'))
        .to eq '2f768cb861c803dd48a2f7a55d05721b'
    end

    specify 'test sign md5 verify' do
      expect(LlPay::Sign::MD5.verify?(LlPay.md5_key, 'oid_partner=201103171000000000&dt_order=20130515094013', '2f768cb861c803dd48a2f7a55d05721b'))
        .to eq true
    end
